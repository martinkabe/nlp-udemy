...
train = pd.read_csv('../large_files/classification_data/r8-train-all-terms.txt',
                    header=None, sep='\t')
test = pd.read_csv('../large_files/classification_data/r8-test-all-terms.txt',
                   header=None, sep='\t')
...
class Word2VecVectorizer:
    def __init__(self):
        ...
        self.word_vectors = KeyedVectors.load_word2vec_format(
            '../large_files/word2vec/GoogleNews-vectors-negative300.bin',
            binary=True
        )
