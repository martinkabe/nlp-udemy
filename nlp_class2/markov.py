...
if __name__ == '__main__':
    ...
    # a matrix where:
    # row = last word (index of the previous word)
    # col = current word (index of current word)
    # value at [row, col] = p(current word | last word) which is the
    # probability of getting the current word given the previous word
